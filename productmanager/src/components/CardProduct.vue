<template>
    <UpdateProduct v-if="isOpenModalUpdate" :callback="viewModal"/>
    <div class="card p-2" style="width: 250px;">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Preço: {{ price }}</li>
            <li class="list-group-item">Validade: {{ expiration_dt }}</li>
        </ul>
        <div class="d-flex justify-content-between card-body">
            ...
            <div>
                <button @click="viewModal(true)" class="border-0 ">
                    ...
                    <path fill="#98ccfd" d="M20,38.5C9.799,38.5,1.5,30.201,1.5,20S9.799,1.5,20,1.5S38.5,9.799,38.5,20S30.201,38.5,20,38.5z"></path><path fill="#4788c7" d="M20,2c9.925,0,18,8.075,18,18s-8.075,18-18,18S2,29.925,2,20S10.075,2,20,2 M20,1 C9.507,1,1,9.507,1,20s8.507,19,19,19s19-8.507,19-19S30.493,1,20,1L20,1z"></path><path fill="#fff" d="M20,30.5c-2.64,0-5.129-0.965-7.064-2.729l2.126-2.126C16.43,26.845,18.165,27.5,20,27.5 c4.136,0,7.5-3.369,7.5-7.51v-0.5h-3.29L29,14.707l4.793,4.793H30.5V20C30.5,25.79,25.79,30.5,20,30.5z"></path><path fill="#fff" d="M29,15.414L32.586,19H31h-1v1c0,5.514-4.486,10-10,10c-2.337,0-4.55-0.794-6.331-2.255l1.425-1.424 C16.491,27.41,18.2,28,20,28c4.411,0,8-3.593,8-8.01v-1h-1h-1.58l1.498-1.493L29,15.414 M29,14l-2.79,2.79L23,19.99h4 c0,3.86-3.14,7.01-7,7.01c-1.93,0-3.68-0.78-4.95-2.05l-2.83,2.83C14.21,29.77,16.96,31,20,31c6.08,0,11-4.92,11-11h4l-5.43-5.43 L29,14L29,14z"></path><g><path fill="#fff" d="M6.207,20.5H9.5V20c0-5.79,4.71-10.5,10.5-10.5c2.64,0,5.129,0.965,7.064,2.728l-2.126,2.126 C23.571,13.155,21.836,12.5,20,12.5c-4.136,0-7.5,3.364-7.5,7.5v0.5h3.293L11,25.293L6.207,20.5z"></path><path fill="#fff" d="M20,10c2.337,0,4.55,0.794,6.331,2.255l-1.425,1.425C23.509,12.59,21.8,12,20,12 c-4.411,0-8,3.589-8,8v1h1h1.586L11,24.586L7.414,21H9h1v-1C10,14.486,14.486,10,20,10 M20,9C13.92,9,9,13.92,9,20H5l5.43,5.43 L11,26l6-6h-4c0-3.86,3.14-7,7-7c1.93,0,3.68,0.78,4.95,2.05l2.83-2.83C25.79,10.23,23.04,9,20,9L20,9z"></path></g>
                    </svg>
                </button>
            </div>
        </div>
